...
TH1F *etazero = new TH1F("etazero","eta zero",20,0.,3.); 
TH1F *etauno = new TH1F("etauno","eta uno",20,0.,3.); 
TH1F *etadue = new TH1F("etadue","eta due",20,0.,3.); 
TH1F *etatre = new TH1F("etatre","eta tre",20,0.,3.); 

MyTree->Project("etazero","abs(fakerecd0)"," fakerecnhit>=8");
MyTree->Project("etauno","abs(fakerecd0)"," fakerecnhit>=8 && fake==1");
...
etadue->SetTitle("Fake rate vs d_{0} for ttbar events");
...
TH1F *etazero_scen1 = new TH1F("etazero_scen1","eta zero",20,0.,3.); 
TH1F *etauno_scen1 = new TH1F("etauno_scen1","eta uno",20,0.,3.); 
TH1F *etadue_scen1 = new TH1F("etadue_scen1","eta due",20,0.,3.); 
TH1F *etatre_scen1 = new TH1F("etatre_scen1","eta tre",20,0.,3.); 

MyTree1->Project("etazero_scen1","abs(fakerecd0)"," fakerecnhit>=8");
MyTree1->Project("etauno_scen1","abs(fakerecd0)"," fakerecnhit>=8 && fake==1");
...
etadue_scen1->SetTitle("Fake rate vs d_{0} for ttbar events");
...
TH1F *etazero_scen2 = new TH1F("etazero_scen2","eta zero",20,0.,3.); 
TH1F *etauno_scen2 = new TH1F("etauno_scen2","eta uno",20,0.,3.); 
TH1F *etadue_scen2 = new TH1F("etadue_scen2","eta due",20,0.,3.); 
TH1F *etatre_scen2 = new TH1F("etatre_scen2","eta tre",20,0.,3.); 

MyTree2->Project("etazero_scen2","abs(fakerecd0)"," fakerecnhit>=8");
MyTree2->Project("etauno_scen2","abs(fakerecd0)"," fakerecnhit>=8 && fake==1");
...
etadue_scen2->SetTitle("Fake rate vs d_{0} for ttbar events");
...
TH1F *etazero_scen3 = new TH1F("etazero_scen3","eta zero",20,0.,3.); 
TH1F *etauno_scen3 = new TH1F("etauno_scen3","eta uno",20,0.,3.); 
TH1F *etadue_scen3 = new TH1F("etadue_scen3","eta due",20,0.,3.); 
TH1F *etatre_scen3 = new TH1F("etatre_scen3","eta tre",20,0.,3.); 

MyTree3->Project("etazero_scen3","abs(fakerecd0)"," fakerecnhit>=8");
MyTree3->Project("etauno_scen3","abs(fakerecd0)"," fakerecnhit>=8 && fake==1");
...
etadue_scen3->SetTitle("Fake rate vs d_{0} for ttbar events");
...
TH1F *etazero_scen4 = new TH1F("etazero_scen4","eta zero",20,0.,3.); 
TH1F *etauno_scen4 = new TH1F("etauno_scen4","eta uno",20,0.,3.); 
TH1F *etadue_scen4 = new TH1F("etadue_scen4","eta due",20,0.,3.); 
TH1F *etatre_scen4 = new TH1F("etatre_scen4","eta tre",20,0.,3.); 

MyTree4->Project("etazero_scen4","abs(fakerecd0)"," fakerecnhit>=8");
MyTree4->Project("etauno_scen4","abs(fakerecd0)"," fakerecnhit>=8 && fake==1");
...
etadue_scen4->SetTitle("Fake rate vs d_{0} for ttbar events");
...
TH1F *etazero_noErr = new TH1F("etazero_noErr","eta zero",20,0.,3.); 
TH1F *etauno_noErr = new TH1F("etauno_noErr","eta uno",20,0.,3.); 
TH1F *etadue_noErr = new TH1F("etadue_noErr","eta due",20,0.,3.); 
TH1F *etatre_noErr = new TH1F("etatre_noErr","eta tre",20,0.,3.); 

MyTree5->Project("etazero_noErr","abs(fakerecd0)"," fakerecnhit>=8");
MyTree5->Project("etauno_noErr","abs(fakerecd0)"," fakerecnhit>=8 && fake==1");
...
etadue_noErr->SetTitle("Fake rate vs d_{0} noErr");
...
etadue->SetXTitle("d_{0}(GeV/c)");
etadue->SetYTitle("Fake Rate");
etadue->SetAxisRange(0.,0.53,"Y");
etadue->Draw();
