...
for (int i=1;i<=nbin;i++){
  ...
  TH1F *resd0= new TH1F("d0","d0",500,-0.004,0.004);   
  MyTree->Project("d0","(rescottheta)",cutname);
  resd0->Fit("gaus");
...
hframe = new TH2F("hframe","Rescottheta_gaus",25,0.,2.5,100,0.00015,0.01);
hframe->SetTitle("#sigma(cot#theta) vs #eta, p_{T} = 100 GeV/c");
hframe->SetXTitle("#eta");
hframe->SetYTitle("#sigma(cot#theta)");
hframe->Draw();
...
gr->Draw("P");
Canv->Update();
//Canv->SaveAs("Rescottheta_gaus_scen0.eps");
//Canv->WaitPrimitive();
...
for (int i=1;i<=nbin;i++){
  ...
  sprintf(cutname,"abs(eta)>=%f && abs(eta)<%f && eff==1 && TrackID==13",binstart, binstop);
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",250,-0.004,0.004);   
  MyTree2->Project("d0","(rescottheta)",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  cost[i-1]=gaus->GetParameter(0);
...
hframe_scen1 = new TH2F("hframe_scen1","Rescottheta_gaus_scen1",25,0.,2.5,100,0.00015,0.01);
hframe_scen1->SetTitle("#sigma(cot#theta) vs #eta, p_{T} = 100 GeV/c");
hframe_scen1->SetXTitle("#eta");
hframe_scen1->SetYTitle("#sigma(cot#theta)");
hframe_scen1->Draw();
...
gr_scen1->Draw("P");
Canv->Update();
//Canv->SaveAs("Rescottheta_gaus_scen1.eps");
//Canv->WaitPrimitive();
...
for (int i=1;i<=nbin;i++){
  ...
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",250,-0.004,0.004);   
  MyTree3->Project("d0","(rescottheta)",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  cost[i-1]=gaus->GetParameter(0);
...
hframe_scen2 = new TH2F("hframe_scen2","Rescottheta_gaus_scen2",25,0.,2.5,100,0.00015,0.01);
hframe_scen2->SetTitle("#sigma(cot#theta) vs #eta, p_{T} = 100 GeV/c");
hframe_scen2->SetXTitle("#eta");
hframe_scen2->SetYTitle("#sigma(cot#theta)");
hframe_scen2->Draw();
...
gr_scen2->Draw("P");
Canv->Update();
//Canv->SaveAs("Rescottheta_gaus_scen2.eps");
//Canv->WaitPrimitive();
...
for (int i=1;i<=nbin;i++){
  ...
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",500,-0.004,0.004);   
  MyTree4->Project("d0","(rescottheta)",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  cost[i-1]=gaus->GetParameter(0);
...
hframe_scen3 = new TH2F("hframe_scen3","Rescottheta_gaus_scen3",25,0.,2.5,100,0.00015,0.01);
hframe_scen3->SetTitle("#sigma(cot#theta) vs #eta, p_{T} = 100 GeV/c");
hframe_scen3->SetXTitle("#eta");
hframe_scen3->SetYTitle("#sigma(cot#theta)");
hframe_scen3->Draw();
...
gr_scen3->Draw("P");
Canv->Update();
//Canv->SaveAs("Rescottheta_gaus_scen3.eps");
//Canv->WaitPrimitive();
...
for (int i=1;i<=nbin;i++){
  ...
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",500,-0.004,0.004);   
  MyTree5->Project("d0","(rescottheta)",cutname);
  resd0->Fit("gaus");
  meanorig[i-1]=1.*resd0->GetMean();
  rms[i-1]=1.*resd0->GetRMS();
  cost[i-1]=gaus->GetParameter(0);
...
hframe_scen4 = new TH2F("hframe_scen4","Rescottheta_gaus_scen3",25,0.,2.5,100,0.00015,0.01);
hframe_scen4->SetTitle("#sigma(cot#theta) vs #eta, p_{T} = 100 GeV/c");
hframe_scen4->SetXTitle("#eta");
hframe_scen4->SetYTitle("#sigma(cot#theta)");
hframe_scen4->Draw();
...
hframe = new TH2F("hframe","#sigma(cot#theta) vs #eta, p_{T} = 100 GeV/c",25,0.,2.5,100,0.0002,0.007);
hframe->SetYTitle("#sigma(cot#theta)");
hframe->SetXTitle("#eta");
hframe->Draw();
...
Canv->Update();
Canv->SaveAs("Rescottheta_eta_gaus_CMSSW.eps");
Canv->SaveAs("Rescottheta_eta_gaus_CMSSW.gif");
