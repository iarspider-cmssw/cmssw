...
hframe = new TH2F("hframe","SigmapT/pT_gaus",25,0.,2.5,100,0.0085,0.4);
hframe->SetTitle("#sigma(p_{T})/p_{T} vs #eta, p_{T} = 100 GeV/c");
...
hframe_scen1 = new TH2F("hframe","SigmapT/pT_gaus_scen1",25,0.,2.5,100,0.0085,0.4);
hframe_scen1->SetTitle("#sigma(p_{T})/p_{T} vs #eta, p_{T} = 100 GeV/c");
...
for (int i=1;i<=nbin;i++){
  ...
  sprintf(cutname,"abs(eta)>=%f && abs(eta)<%f && eff==1 && TrackID==13",binstart, binstop);
  cout << "cutname is " << cutname <<endl;
  TH1F *resd0= new TH1F("d0","d0",150,-0.3,0.3);  
...
hframe_scen2 = new TH2F("hframe_scen2","SigmapT/pT_gaus_scen2",25,0.,2.5,100,0.0085,0.4);
hframe_scen2->SetTitle("#sigma(p_{T})/p_{T} vs #eta, p_{T} = 100 GeV/c");
...
hframe_scen3 = new TH2F("hframe_scen3","SigmapT/pT_gaus_scen3",25,0.,2.5,100,0.0085,0.4);
hframe_scen3->SetTitle("#sigma(p_{T})/p_{T} vs #eta, p_{T} = 100 GeV/c");
...
hframe_scen1_NOAPE = new TH2F("hframe_scen1_noAPE","SigmapT/pT_gaus_scen1_NOAPE",25,0.,2.5,100,0.0085,0.4);
hframe_scen1_NOAPE ->SetTitle("#sigma(p_{T})/p_{T} vs #eta, p_{T} = 100 GeV/c");
hframe_scen1_NOAPE ->SetXTitle("#eta");
hframe_scen1_NOAPE ->SetYTitle("#sigma(p_{T})/p_{T}");
hframe_scen1_NOAPE ->Draw();
gr_scen1_NOAPE = new TGraphErrors(25,etabin,sigma,erretabin,errsigma);
gr_scen1_NOAPE ->SetMarkerColor(6);
gr_scen1_NOAPE ->SetMarkerStyle(24);
gr_scen1_NOAPE ->Draw("P");
Canv->Update();
//Canv->SaveAs("SigmapT_gaus_scen2.eps");
//Canv->WaitPrimitive();
...
Canv->Update();
Canv->SaveAs("SigmapT_eta_gaus.eps");
Canv->SaveAs("SigmapT_eta_gaus.gif");
