...
private:
  ...
  Int_t fMenuD_MSp_SpNbLineFullC, fMenuD_MSp_SpNbLineSameC, fMenuD_MSp_SpNbLineAllStinC;

  TGPopupMenu *fMenuD_MSp_SpDs;
  TGMenuBar *fMenuBarD_MSp_SpDs;
  Int_t fMenuD_MSp_SpDsLineFullC, fMenuD_MSp_SpDsLineSameC, fMenuD_MSp_SpDsLineAllStinC;

  TGPopupMenu *fMenuD_SSp_SpNb;
  TGMenuBar *fMenuBarD_SSp_SpNb;
  Int_t fMenuD_SSp_SpNbLineFullC, fMenuD_SSp_SpNbLineSameC, fMenuD_SSp_SpNbLineAllStinC;

  TGPopupMenu *fMenuD_SSp_SpDs;
  TGMenuBar *fMenuBarD_SSp_SpDs;
  Int_t fMenuD_SSp_SpDsLineFullC, fMenuD_SSp_SpDsLineSameC, fMenuD_SSp_SpDsLineAllStinC;
