...
process.load("CalibTracker.SiStripESProducers.DBWriter.SiStripBadFiberDummyDBWriter_cfi")
...
process.siStripBadFiberDummyDBWriter.record=process.PoolDBOutputService.toPut[0].record
